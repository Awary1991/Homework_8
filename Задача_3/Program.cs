...
if (!isParsesizeRowFirst || !isParsesizeColumnFirst) { Console.WriteLine("Введено не число"); return; }
...
if (!isParsesizeRowSecond || !isParsesizeColumnSecond) { Console.WriteLine("Введено не число"); return; }
